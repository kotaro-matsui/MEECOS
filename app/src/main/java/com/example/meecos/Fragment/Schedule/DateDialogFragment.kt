...
//              DialogFragmentを呼び出したボタンのテキストに日付をセット
            ...
            .also {
                    ...
                    if(button === startDateBtn && endDateBtn.text != dateDefault){
                    ...
                    if(button === endDateBtn && startDateBtn.text != dateDefault){
    ...
    override fun onCancel(dialog: DialogInterface) {
        ...
        button.text = context?.getString(R.string.schedule_date)
    }
